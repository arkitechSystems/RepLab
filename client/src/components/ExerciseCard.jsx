    ...
    <div data-tutorial={dataTutorial ? 'exercise-card' : undefined} className="exercise-card-light-test glass-card rounded-xl overflow-hidden mb-3">
      ...
      {!readOnly && (
        <div className="px-4 py-2 border-b border-white/5 flex items-center gap-1.5 bg-white/[0.015]">
            ...
            {onMoveUp && (
              <button type="button" onClick={onMoveUp} className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-wf-gray-400 hover:text-white hover:bg-white/20 active:scale-90 transition-all">
            ...
            {onMoveDown && (
              <button type="button" onClick={onMoveDown} className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-wf-gray-400 hover:text-white hover:bg-white/20 active:scale-90 transition-all">
            ...
            {onAddExercise && (
              <button type="button" onClick={() => { setShowAddBelow(true); setAddBelowSearch(''); }} className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-wf-gray-400 hover:text-green-400 hover:bg-green-500/20 active:scale-90 transition-all">
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
              </button>
            )}
            {onDeleteExercise && (
              <button type="button" onClick={onDeleteExercise} className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-wf-gray-400 hover:text-red-400 hover:bg-red-500/20 active:scale-90 transition-all">
