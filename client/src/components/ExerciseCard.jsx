          ...
          <div className="shrink-0 flex items-center gap-1.5">
            {onShowPRs && (
              <button
                ...
                className="h-7 px-2.5 rounded-lg flex items-center gap-1.5 active:scale-95 transition-all bg-wf-red/10 border border-wf-red/20"
              >
            ...
            <button
              ...
              className={`h-7 px-2.5 rounded-lg flex items-center gap-1.5 active:scale-95 transition-all ${showDemo ? 'bg-wf-red/20 border border-wf-red/40' : 'bg-wf-red/10 border border-wf-red/20'}`}
            >
              <svg className="w-3.5 h-3.5 text-wf-red" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
