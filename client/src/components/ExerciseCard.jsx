    ...
    <div data-tutorial={dataTutorial ? 'exercise-card' : undefined} className={`exercise-card-light-test glass-card rounded-xl overflow-hidden mb-3${EXERCISE_CARD_GRADIENT_BORDER ? ' exercise-card-gradient-border' : ''}`}>
      ...
      {!readOnly && (
        <div className="px-4 py-2 border-b border-white/5 flex items-center gap-1.5 bg-white/[0.015]">
            ...
            {onMoveUp && (
              <button type="button" onClick={onMoveUp} aria-label="Move exercise up" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-wf-gray-400 hover:text-white hover:bg-white/20 active:scale-90 transition-all">
            ...
            {onMoveDown && (
              <button type="button" onClick={onMoveDown} aria-label="Move exercise down" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-wf-gray-400 hover:text-white hover:bg-white/20 active:scale-90 transition-all">
            ...
            {onSwapExercise && (
              <button type="button" data-tutorial={dataTutorial ? 'swap-button' : undefined} onClick={() => { setShowSwap(true); setSwapSearch(''); }} className="h-10 px-2.5 rounded-full bg-white/10 flex items-center gap-1 text-wf-gray-400 hover:text-blue-400 hover:bg-blue-500/20 active:scale-90 transition-all">
            ...
            {onAddExercise && (
              <button type="button" onClick={() => { setShowAddBelow(true); setAddBelowSearch(''); }} aria-label="Add exercise below" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-wf-gray-400 hover:text-green-400 hover:bg-green-500/20 active:scale-90 transition-all">
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
              </button>
            )}
            {onDeleteExercise && (
              <button type="button" onClick={onDeleteExercise} aria-label="Delete exercise" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-wf-gray-400 hover:text-red-400 hover:bg-red-500/20 active:scale-90 transition-all">
        ...
        <div data-tutorial={dataTutorial ? 'set-controls' : undefined} className="px-4 py-2 border-b border-white/10 flex items-center justify-between bg-white/[0.02]">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="h-10 px-2.5 rounded-full bg-white/10 flex items-center justify-center gap-1 text-wf-gray-400 hover:text-white hover:bg-white/20 active:scale-90 transition-all"
            >
            ...
            {onDeleteSet && exercise.sets.length > 1 && (
              <button
                ...
                className="h-10 px-2.5 rounded-full bg-white/10 flex items-center justify-center gap-1 text-wf-gray-400 hover:text-red-400 hover:bg-red-500/20 active:scale-90 transition-all"
              >
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
