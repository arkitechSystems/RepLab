...
export default function PBCelebration({ exerciseNames, onDismiss }) {
    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-[100] flex justify-center pt-4 safe-top pointer-events-none">
        <div className={`pb-toast ${dismissing ? 'dismissing' : ''} pointer-events-auto`}>
          <div className="mx-4 glass-card !bg-amber-500/20 !border-amber-500/40 rounded-xl px-5 py-4 flex items-center gap-3 shadow-lg shadow-amber-500/20 relative">
            ...
            <div className="flex-1">
              <h3 className="text-amber-400 font-bold text-base">New PR!</h3>
