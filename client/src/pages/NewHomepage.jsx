...
export default function NewHomepage() {
  ...
  return (
    <div className="min-h-screen pb-24" style={{ background: 'linear-gradient(180deg, #1a1a1a 0%, #0d0d0d 40%, #111 70%, #0a0a0a 100%)' }}>
      ...
      {/* ===== FEATURED WORKOUTS — swapped from NikeTestHomepage HERO ===== */}
        ...
        <div className="relative flex flex-col items-center pt-6 pb-8">
          ...
          <div className="mt-6 text-center px-8">
            ...
            <button
              ...
              className="px-10 py-3 rounded-full border border-white/70 text-white text-[11px] font-semibold uppercase tracking-[0.2em] active:bg-white/10 transition-colors"
