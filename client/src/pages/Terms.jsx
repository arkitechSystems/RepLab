      ...
      <div className="space-y-4 text-sm text-wf-gray-300 leading-relaxed">
        ...
        <section className="relative overflow-hidden" style={sectionPanelStyle}>
          <div className="relative p-6">
            ...
            <div className="border-t border-white/5 pt-3">
              <p>The App is currently free to use, with no paid subscriptions or purchases required to access any feature. If we introduce paid subscriptions in the future, these Terms will be updated accordingly, and any such subscriptions would be disclosed clearly before purchase, would automatically renew unless cancelled before the end of the current billing period, and would be subject to the refund policies of the platform through which they were purchased.</p>
            </div>
          </div>
        </section>
