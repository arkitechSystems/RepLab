// One-off: add "Cross-Body Hammer Strength Press" to the master library
// under the Chest muscle group with the machine tag. Idempotent.

import pool from '../dbPool.js';

const NAME = 'Cross-Body Hammer Strength Press';
