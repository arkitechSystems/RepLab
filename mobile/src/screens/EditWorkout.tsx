            ...
            setTemplateExercises(
              template.exercises.map((ex: any) => ({
                ...
                sets: (ex.sets || []).map((s: any) => ({
                  reps: s.plannedReps ?? s.reps ?? 0,
                  weight: s.suggestedWeight ?? s.weight ?? 0,
                })),
              }))
            );
          }
